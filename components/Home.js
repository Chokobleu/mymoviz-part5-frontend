...
function Home() {
  ...
  useEffect(() => {
    fetch('https://mymoviz-part5-backend-alpha.vercel.app/movies')
    ...
    return <Movie key={i} updateLikedMovies={updateLikedMovies} isLiked={isLiked} title={data.title} overview={truncate(data.overview)} poster={"https://image.tmdb.org/t/p/w500/"+data.poster_path} voteAverage={data.vote_average} voteCount={data.vote_count} />;
  });
